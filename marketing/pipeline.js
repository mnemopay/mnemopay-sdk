...
const CONTENT_BANK = {
  tweets: [
    ...
    // Commerce — escrow-protected transaction infrastructure
    {
      type: "problem-solution",
    ...
    {
      type: "stat-hook",
      stat: "Perplexity just got blocked from Amazon by a federal court.\n\nThe lesson: agent commerce needs proper financial infrastructure, not hacks.",
      insight: "MnemoPay: escrow-protected payments, mandate-enforced budgets, and fraud detection. The financial layer any commerce solution needs underneath.",
    },
    {
      type: "stat-hook",
    ...
    {
      type: "hot-take",
      take: "The agent commerce wars just started.\n\nPerplexity vs Amazon. Google vs Walmart. Stripe vs PayPal.\n\nBut nobody built the financial infrastructure layer. The escrow, mandates, fraud detection, and audit trail that ANY agent commerce solution needs.\n\nThat's what we built.",
      cta: "MnemoPay: agent financial infrastructure.\nnpm install @mnemopay/sdk",
    },
  ],
  ...
  linkedin: [
    ...
    },
    {
      ...
      proof: "We built transaction mandates — cryptographically enforced spending policies that define HOW MUCH your agent can spend, WHICH categories are allowed, and WHO it can transact with.\n\nEvery payment goes through escrow. The counterparty gets paid when you confirm delivery. Not before.",
  ...
  blog_topics: [
    ...
    "How to enforce budget caps and approval gates on AI agent spending",
    "Transaction Mandates: Financial controls for autonomous AI agents",
    "Why agent commerce needs escrow infrastructure (Perplexity vs Amazon case study)",
    "Building the financial middleware layer for agent commerce",
    "Stripe ACP vs Google UCP vs MnemoPay: Agent financial infrastructure comparison",
  ],
  ...
  seo_keywords: [
    ...
    "ai agent escrow payments",
    "ai agent commerce infrastructure",
    "escrow protected agent payments",
    "transaction mandate ai agent",
    "ai agent spending controls",
    "agent commerce financial layer",
    "ai agent budget enforcement",
    "agent payment mandate sdk",
  ],
};
